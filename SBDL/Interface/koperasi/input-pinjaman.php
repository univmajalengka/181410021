...
<?php
	...
	$input	="INSERT INTO data_pinjaman (username, nama, tgl_transaksi, jml_transaksi) VALUES ('$username','$nama','$tgl_transaksi','$jml_transaksi')";
	$query_input =mysqli_query($koneksi, $input);
	//Update pinjaman di tabel member
	$update="UPDATE data_anggota SET pinjaman=pinjaman + $jml_transaksi WHERE username='$username'";

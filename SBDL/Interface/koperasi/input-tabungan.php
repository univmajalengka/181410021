...
<?php
	...
	$input	="INSERT INTO data_tabungan (username, nama, tgl_tabungan, jml_tabungan) VALUES ('$username','$nama','$tgl_tabungan','$jml_tabungan')";
	$query_input =mysqli_query($koneksi, $input);
	//Update tabungan di tabel member
	$update="UPDATE data_anggota SET tabungan=tabungan + $jml_tabungan WHERE username='$username'";

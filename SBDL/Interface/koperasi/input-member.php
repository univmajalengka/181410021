...
<?php
	...
	$cek=mysqli_num_rows (mysqli_query($koneksi, "SELECT username FROM data_anggota WHERE username='$_POST[username]'"));
	if ($cek > 0) {
	?>
			<script language="JavaScript">
...
$input1	="INSERT INTO data_anggota (username, password, nama, nik, tgl_lahir, jenis_kelamin, pekerjaan, alamat, email, no_hp)
...
$query_input2 =mysqli_query($koneksi, $input2);
	if ($query_input1) {
	//Jika Sukses
?>
		<script language="JavaScript">

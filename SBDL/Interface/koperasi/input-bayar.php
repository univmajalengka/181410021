...
<?php
	...
	$input	="INSERT INTO data_pembayaran (username, nama, tgl_bayar, jml_bayar) VALUES ('$username','$nama','$tgl_bayar','$jml_bayar')";
	$query_input =mysqli_query($koneksi, $input);
	//Update pinjaman di tabel member
	$update="UPDATE data_anggota SET pinjaman=pinjaman - $jml_bayar WHERE username='$username'";
